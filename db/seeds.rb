...
20.times do 
	User.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, description: Faker::Lorem.paragraph_by_chars(number: 30), email: "#{Faker::Lorem.characters(number: 10)}@yopmail.com", encrypted_password: "youhou")
end
puts "users créés"
